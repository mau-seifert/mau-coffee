            ...
            <aside class="hidden lg:block self-start sticky top-10">
                <div class="space-y-8 pr-8">
                    ...
                    <footer class="border-t border-taupe-900/20 pt-4 text-xs text-taupe-900/70">
                        <p class="flex items-center gap-4"><a href="/privacy" class="<?= $isPrivacy ? 'underline' : 'hover:underline' ?> underline-offset-4">Privacy</a><a href="https://tangled.org/mau.coffee/mau-coffee" class="text-taupe-900/70 hover:underline" target="_blank" rel="noopener noreferrer">Source</a></p>
                    </footer>
                </div>
            </aside>
